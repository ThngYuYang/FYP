...
namespace L08.Controllers
{
   public class TravelController : Controller
   {
      ...
      public IActionResult MyTrips()
      {
         ...
         string userid = userid = User.FindFirst(ClaimTypes.NameIdentifier).Value;
      ...
      public IActionResult Create(Trip trip, IFormFile photo)
      {
         ...
         else
         {
            ...
            string sql = @"INSERT INTO TravelHighlight(Title,City,TripDate,Duration,Spending,Story,Picture,UserId) VALUES('{0}','{1}','{2:yyyy-MM-dd}',{3},{4},'{5}','{6}','{7}')";
